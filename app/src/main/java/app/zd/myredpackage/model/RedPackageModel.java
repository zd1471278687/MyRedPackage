package app.zd.myredpackage.model;
...
public class RedPackageModel {
     ...
     * @return
     */
    private BigDecimal randomRedPacket(BigDecimal money, BigDecimal minS, BigDecimal maxS, int count) {
        //当人数剩余一个时，把当前剩余全部返回
        if (count == 1) {
            return money;
        }
     ...
     * @return
     */
    private boolean isRight(BigDecimal money, int count) {
